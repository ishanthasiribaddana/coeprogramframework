---
description: One-command release for COE Program Framework — Auto-detects changes, bumps version, updates package.json + CHANGELOG.md, builds backend (Node.js) + frontend (React), commits, tags, and pushes to trigger CI/CD pipeline that deploys to production.
---
